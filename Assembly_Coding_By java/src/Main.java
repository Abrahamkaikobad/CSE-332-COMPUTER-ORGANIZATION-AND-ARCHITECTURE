...
class RType extends Instruction {
    private String rs = "00";
    private String rt = "00";
    private String rd = "00";
    private String[] reg = {"00", "00", "00"};
...
//        return opcode +" "+ rs +" "+ rt +" "+ rd +" "+ shamt;
    ...
    public String HexCode(){
        ...
        return numberConversion.BinaryToHexaDecimal("00"+opcode.substring(0,2))+numberConversion.BinaryToHexaDecimal(opcode.substring(2,4)+rs)+numberConversion.BinaryToHexaDecimal(rt+rd);
        
    }
}

class IType extends Instruction {
    private final short immediateBits = 1;
    private char sign;
    private String rs = "00";
    private String rt = "00";
    private String immediate = "0";
...
//        return opcode + " " +rs + " " +rt +" " + sign +" " + immediate;
    ...
    public String HexCode(){
        NumberConversion numberConversion = new NumberConversion();
        System.out.println(sign+immediate);
        return numberConversion.BinaryToHexaDecimal("00"+opcode.substring(0,2))+numberConversion.BinaryToHexaDecimal(opcode.substring(3,4)+rs)+numberConversion.BinaryToHexaDecimal(rt+sign+immediate);
    }
}

class JType extends Instruction {
    private short targetBits = 6;
    private String target = "000000";
                ...
                try {
                    ...
                    if (op_code.containsKey(opcode) && opcode.equals("j")) {
                        ...
                        try {
                            ...
                            fwMachineCode.write("J-type "+code+"\n");
                        ...
                        try {
                            if (reg_file.containsKey(ins)) {
                                RType code = new RType(op_code.get(opcode), "00", "00",reg_file.get(ins));
                    ...
                    if (op_code.containsKey(opcode)) {
                        ...
                        if (Integer.parseInt(opcode, 2) < 9) {           // our r-type instructions are to 1000 binary
                            try {
                                ...
                                fwMachineCode.write("R-type "+code+"\n");
                                fwHexCode.write(code.HexCode()+"\n");
                            } catch (Exception e) {
                                System.out.print(temp+ " : ");
                                System.out.println(e);
                        	...
                        	// our i-type instructions are to 1101 binary
                            //System.out.println(Integer.parseInt(opcode, 2)+" I-type");
                        	regArray[0] = regArray[0].trim();
                        	//System.out.println("reg- array:"+regArray[0]);
                            ...
                            if (regArray.length == 3) {
                             ...
                             //   System.out.println(regArray[1]);
                                ...
                                try {
                                    ...
                                    fwMachineCode.write("I-type "+code+"\n");
                                    fwHexCode.write(code.HexCode()+"\n");
